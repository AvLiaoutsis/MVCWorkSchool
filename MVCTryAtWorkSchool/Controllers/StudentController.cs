...
namespace MVCTryAtWorkSchool.Controllers
{
    public class StudentController : Controller
    {
        ...
        public ViewResult Index(string sortOrder, string searchString,string currentFilter, int? page)
        {
            ...
            ViewBag.FeesSortParm = sortOrder == "Fee" ? "fee_desc" : "Fee";
        ...
        public ActionResult Create([Bind(Include = "FirstName,LastName,DateOfBirth,TuitionFees")] Student student)
        {
            try
            {
        ...
        public ActionResult EditPost(int? id)
        {
            ...
            if(TryUpdateModel(studentToUpdate,"",new string[] { "FirstName", "LastName", "DateOfBirth", "TuitionFees" }))
            {
                try
                {
                    db.SaveChanges();
